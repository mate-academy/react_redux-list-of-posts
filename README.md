...
- `selectedPost`;
- `commentsSlice` with `loaded`, `hasError` and `items` props (keep the `visible` in the `PostDetails`);
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Kateryna99.github.io/react_redux-list-of-posts/) and add it to the PR description.
