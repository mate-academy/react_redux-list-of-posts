...
- `users` and remove `UsersContext`; // done
- `author` that is currently in the `App`; // done
- `posts` having 3 props `loaded`, `hasError` and `items`; // done
- `selectedPost`; // done
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://mikezhylka.github.io/react_redux-list-of-posts/) and add it to the PR description.
