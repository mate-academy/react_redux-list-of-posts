...
You can use the `User` component from both `Post` (with address) and `CommentItem` (without providing any address).
...
Add link here: `[DEMO LINK](https://innocent1312.github.io/react_redux-list-of-posts/)`
