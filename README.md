...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://read-my-code.github.io/react_redux-list-of-posts/) and add it to the PR description.
