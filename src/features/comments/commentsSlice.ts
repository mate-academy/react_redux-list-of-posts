...
export const addPostComment = createAsyncThunk<Comment, CommentAddValues, { rejectValue: string }>(
    "comments/addPostComment",
    async (CommentAddValues, { rejectWithValue }) => {
        try {
...
export const deletePostComment = createAsyncThunk<number, number, { rejectValue: string }>(
