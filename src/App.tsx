...
import { fetchPostsByUser, resetPosts } from './slices/postsSlice';
import { clearSelectedPost } from './slices/selectedPostSlice';
...
export const App: React.FC = () => {
  ...
  const postsLoaded = useAppSelector(s => s.posts.loaded);
