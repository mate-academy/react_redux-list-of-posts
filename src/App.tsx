...
export const App: React.FC = () => {
  ...
  const postsDispatch = useAppDispatch();
  ...
  useEffect(() => {
    ...
    if (author) {
      postsDispatch(postsActions.init(author.id));
    } else {
      postsDispatch(postsActions.clearPosts());
    }
  }, [author, postsDispatch, selectedPostDispatch]);
