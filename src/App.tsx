...
import { clearPosts, setPosts } from './features/postsSlice';
import { setSelectedPost } from './features/selectedPostSlice';

export const App: React.FC = () => {
  const dispatch = useAppDispatch();
  const { posts, hasError, loaded } = useAppSelector(state => state.postsState);
  const selectedPost = useAppSelector(
    state => state.selectedPostState.selectedPost,
  );
