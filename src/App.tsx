...
import { actions } from './features/author/authorSlice';
...
export const App: React.FC = () => {
  ...
  const dispatchAuthor = (newAuthor: User) => {
    dispatch(actions.setAuthor(newAuthor));
  };
        ...
        <div className="tile is-ancestor">
          <div className="tile is-parent">
            <div className="tile is-child box is-success">
              <div className="block">
                <UserSelector value={author} onChange={dispatchAuthor} />
              </div>
