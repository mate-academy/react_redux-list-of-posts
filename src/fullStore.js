...
const SET_VISIBLE_POSTS = 'SET_VISIBLE_POSTS';

export const getVisiblePosts = visiblePosts => ({
...
export const showVisiblePosts = state => state.visiblePosts
  ...
  switch (action.type) {
    ...
    case PREPARE_POSTS:
      return {
        ...
        visiblePosts: action.preparedPosts,
      };
    case DELETE_POST:
      return {
        ...state,
