...
import * as commentsActions from '../thunks/commentsThunk';
import { localDeleteComment } from '../features/comments/commentsSlice';

export const PostDetails: React.FC = () => {
  const dispatch = useAppDispatch();
  const { loaded, isError, comments } = useAppSelector(state => state.comments);
  ...
  const deleteComment = (commentId: number) => {
    dispatch(localDeleteComment(commentId));
