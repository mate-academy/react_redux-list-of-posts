...
import { addComment, clearComments, fetchCommentsByPostId, removeComment, restoreComment, setCommentsError } from '../features/comments/commentsSlice';
...
export const PostDetails: React.FC<Props> = ({ post }) => {
  ...
  const handleDeleteComment = async (commentId: number) => {
    ...
    try {
      ...
      if (commentToDelete) {
        dispatch(restoreComment(commentToDelete));
      }
