...
export const PostDetails: React.FC<Props> = ({ post }) => {
  ...
  function loadComments() {
    ...
    commentsApi.getPostComments(post.id)
      .then((data) => dispatch(commentsAction.loadComments(data))) // save the loaded comments
      .catch(() => dispatch(commentsAction.setError(true))) // show an error when something went wrong
      .finally(() => dispatch(commentsAction.setLoading(true))); // hide the spinner
  }
