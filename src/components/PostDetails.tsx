...
import {
  selectComments,
  selectCommentsIsError, selectCommentsIsLoading, setComments,
  setCommentsError,
...
export const PostDetails: React.FC<Props> = ({ post }) => {
  ...
  const hasError = useSelector(selectCommentsIsError);
  const loaded = !useSelector(selectCommentsIsLoading);
  ...
  function loadComments() {
    ...
    commentsApi.getPostComments(post.id)
      .then((receivedComments) => dispatch(setComments(receivedComments)))
      .catch(() => dispatch(setCommentsError(true)))
      .finally(() => dispatch(setCommentsIsLoading(false)));
  }
