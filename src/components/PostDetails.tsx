...
import { fetchComments, removeComment } from '../features/commentsSlice';
...
export const PostDetails: React.FC<Props> = ({ post }) => {
  ...
  const {
    ...
    return {
      ...
      errorText: state.comments.errorText,
      value: state.comments.value,
      onDeleting: state.comments.onDeleting,
    };
  });
